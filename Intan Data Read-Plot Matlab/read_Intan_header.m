...
% Shiv REV 
%     - "move_to_base_workspace" >> struct "info"
%     - Added File/path
% 
...
if (data_present)
    ...
    if verbose; fprintf(1, 'Allocating memory for data...\n'); end
    ...
    if verbose; fprintf(1, 'Reading data from file...\n'); end
...
if (data_present)
    ...
    if verbose; fprintf(1, 'Parsing data...\n'); end
    ...
    if (notch_filter_frequency > 0)
        if verbose; fprintf(1, 'Applying notch filter...\n'); end
